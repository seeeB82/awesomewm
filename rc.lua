...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "Terminal", "Browser", "Develop", "4", "5", "6", "7", "8", "9" }, s, awful.layout.layouts[1])
...
client.connect_signal("unfocus", function(c) c.border_color = beautiful.border_normal c.opacity=1.0 end)
-- }}}
